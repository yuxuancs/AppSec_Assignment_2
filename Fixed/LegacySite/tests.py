...
class MyTest(TestCase):
    ...
    def test_1(self):
        ...
        if string.__contains__("&lt;script&gt"): # check whether "<" and ">" <=> "&lt" and "&gt"
            return "Preventing XSS test passed!"
        else:
            return None
    ...
    def test_2(self):
        ...
        if resp.status_code == 403:
            return "Preventing CRSF test passed!"
        else:
            return None
    ...
    def test_3(self):
        ...
        if len(card_query) == 0:
            return "Preventing SQL Injection test passed!"
        else:
            return None
    ...
    def test_4(self):
        ...
        ret_val = os.system(quote(f"./giftcardreader 2 {card_path_name} > tmp_file"))
        if ret_val != 0:
            return "Preventing Command Injection test passed!"
        else:
            return None
